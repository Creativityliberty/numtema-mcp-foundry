            ...
            try {
                ...
                if (message.method === 'resources/list') {
                    if (options.resources === undefined)
                        return failure(id, -32601, 'Resources are not supported.');
                    const params = asRecord(message.params);
                    const cursor = typeof params.cursor === 'string' ? params.cursor : undefined;
                ...
                if (message.method === 'resources/read') {
                    ...
                    if (typeof uri !== 'string' || uri.length === 0)
                        return failure(id, -32602, 'Invalid params: resource URI is required.');
                ...
                if (message.method === 'tools/call') {
                    ...
                    if (typeof name !== 'string' || name.length === 0)
                        return failure(id, -32602, 'Invalid params: tool name is required.');
                    if (options.registry.get(name) === undefined)
                ...
                if (text === 'INVALID_CURSOR')
                    return failure(id, -32602, 'Invalid pagination cursor.');
...
//# sourceMappingURL=jsonrpc-router.js.map