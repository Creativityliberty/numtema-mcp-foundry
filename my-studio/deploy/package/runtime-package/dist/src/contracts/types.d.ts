...
export type PolicyDecision = 'allow' | 'deny' | 'require_scope' | 'require_confirmation' | 'require_widget' | 'require_approver';
...
export type ApprovalBinding = 'subject' | 'client' | 'workspace' | 'tool_id' | 'tool_revision' | 'arguments_hash' | 'risk_summary' | 'cost_summary' | 'nonce';
...
export type ContractKind = 'tool' | 'auth' | 'policy' | 'approval' | 'recovery' | 'receipt' | 'artifact';
