...
import type { ContractBundle, ContractKind } from '../contracts/types.js';
import { createSchemaRegistry } from '../schema/schema-registry.js';
import { sortValidationIssues, type ValidationIssue, type ValidationReport } from './issues.js';
...
const COLLECTIONS: Array<{ kind: ContractKind; key: keyof ContractBundle }> = [
  { kind: 'tool', key: 'tools' },
  { kind: 'auth', key: 'auth' },
