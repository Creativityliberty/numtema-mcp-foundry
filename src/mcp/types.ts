...
export interface McpToolRegistry {
  list(cursor?: string): { tools: McpToolDescriptor[]; nextCursor?: string };
...
export interface McpResourceRegistry {
  list(cursor?: string): { resources: McpResourceDescriptor[]; nextCursor?: string };
  read(uri: string): { contents: McpResourceContent[] } | undefined;
}
